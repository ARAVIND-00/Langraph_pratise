...
# db.save_local("local","index")
# db.load_local(folder_path="local",embeddings=embedding_function,index_name="index",allow_dangerous_deserialization=True)
...
print(qa_chain.invoke("Who is the owner and what are the timings?"))